...
/** @brief Flag enable process sink debug messages */
#define DBG_PROCESS_SINK DBG_ON
...
#define STREAMER_DEFAULT_OUT_DEVICE AUDIO_SINK_DEVICE_TYPE_DEFAULT
