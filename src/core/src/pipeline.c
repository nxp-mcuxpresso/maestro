...
int32_t create_pipeline(PipelineHandle *handle, unsigned int index, STREAMER_OUT_MESSAGE_CHANNEL_T * message_channel_out)
{
    ...
    pipeline->message_channel_out = message_channel_out;
