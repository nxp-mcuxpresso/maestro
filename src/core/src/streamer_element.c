...
/* Elements */
// Translation from Zephyr Kconfig
// TBD in nicer way
#if defined(CONFIG_MAESTRO_ENABLE_ELEMENT_MEM_SRC) && (CONFIG_MAESTRO_ENABLE_ELEMENT_MEM_SRC == 1)
#undef STREAMER_ENABLE_MEM_SRC
#define STREAMER_ENABLE_MEM_SRC
#endif
#if defined(CONFIG_MAESTRO_ENABLE_ELEMENT_MEM_SINK) && (CONFIG_MAESTRO_ENABLE_ELEMENT_MEM_SINK == 1)
#undef STREAMER_ENABLE_MEM_SINK
#define STREAMER_ENABLE_MEM_SINK
#endif
#if defined(CONFIG_MAESTRO_ENABLE_ELEMENT_AUDIO_SRC) && (CONFIG_MAESTRO_ENABLE_ELEMENT_AUDIO_SRC == 1)
#undef STREAMER_ENABLE_AUDIO_SRC
#define STREAMER_ENABLE_AUDIO_SRC
#endif
#if defined(CONFIG_MAESTRO_ENABLE_ELEMENT_AUDIO_SINK) && (CONFIG_MAESTRO_ENABLE_ELEMENT_AUDIO_SINK == 1)
#undef STREAMER_ENABLE_AUDIO_SINK
#define STREAMER_ENABLE_AUDIO_SINK
#endif
#if defined(CONFIG_MAESTRO_ENABLE_ELEMENT_PROCESS_SINK) && (CONFIG_MAESTRO_ENABLE_ELEMENT_PROCESS_SINK == 1)
#undef STREAMER_ENABLE_PROCESS_SINK
#define STREAMER_ENABLE_PROCESS_SINK
#endif
#if defined(CONFIG_MAESTRO_ENABLE_ELEMENT_AUDIO_PROC) && (CONFIG_MAESTRO_ENABLE_ELEMENT_AUDIO_PROC == 1)
#undef STREAMER_ENABLE_AUDIO_PROC
#define STREAMER_ENABLE_AUDIO_PROC
#endif

#ifdef STREAMER_ENABLE_AUDIO_SRC
#include "audio_src.h"
#endif

#ifdef STREAMER_ENABLE_AUDIO_SINK
...
#include "net_src.h"
#endif
#ifdef STREAMER_ENABLE_PROCESS_SINK
...
#ifdef STREAMER_ENABLE_PROCESS_SINK
    /*! TYPE_ELEMENT_PROCESS_SINK */
    {sizeof(ElementProcessSink), processsink_init_element},
#else
    {0, NULL},
#endif
