...
extern const AudioSinkPadDeviceIOFuncType audio_sink_device_default;
...
int32_t audiosink_init_element(StreamElement *element)
{
    ...
    audio_sink_ptr->device_ptr         = &audio_sink_device_default;
                                                          ...
                                                          AudioSinkDeviceDriverType device_driver_type)
{
    ...
    {
        case AUDIO_SINK_DEVICE_TYPE_DEFAULT:
            audio_sink_ptr->device_ptr = &audio_sink_device_default;
            break;
