                                     ...
                                     STREAMER_T *task_data)
{
    ...
    if (STREAM_OK != ret)
    {
        STREAMER_LOG_ERR(DBG_CORE, ERRCODE_INTERNAL, "link element(%d) to element(%d) failed:%d\n",
                         ELEMENT_MICROPHONE_INDEX, ELEMENT_FILE_SINK_INDEX, ret);
        goto err_catch;
    }
    ...
    if (STREAM_OK != ret)
    {
        STREAMER_LOG_ERR(DBG_CORE, ERRCODE_INTERNAL, "set element(%d) property(%d) failed:%d in raw mode\n",
                         ELEMENT_FILE_SINK_INDEX, PROP_SPEAKER_DEVICE_DRIVER_TYPE, ret);
        goto err_catch;
    }

    /* Set the audio sink device name */
    /* Not for file sink */
    /* prop.prop = PROP_SPEAKER_DEVICE_DRIVER_STRING_NAME;
    ...
    if (STREAM_OK != ret) {
        STREAMER_LOG_ERR(DBG_CORE, ERRCODE_INTERNAL,
             ...
             PROP_SPEAKER_DEVICE_DRIVER_STRING_NAME, ret);
        goto err_catch;
    }*/
