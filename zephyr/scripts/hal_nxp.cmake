...
if(CONFIG_NXP_OSA)
    ...
    zephyr_library_sources(${CMAKE_CURRENT_SOURCE_DIR}/mcux-sdk/components/osa/fsl_os_abstraction_zephyr.c)

  if(CONFIG_NXP_OSA_INCLUDE_TASK_API)
    zephyr_compile_definitions(FSL_OSA_TASK_ENABLE=1)
  endif()
endif()
